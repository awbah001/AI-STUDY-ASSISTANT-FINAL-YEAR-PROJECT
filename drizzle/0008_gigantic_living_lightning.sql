CREATE TABLE `announcements` (
	...
	`createdAt` integer DEFAULT '"2026-05-20T00:03:39.101Z"' NOT NULL
);
...
CREATE TABLE `assignments` (
	...
	`documentId` integer,
	`createdAt` integer DEFAULT '"2026-05-20T00:03:39.101Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-05-20T00:03:39.101Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `courseEnrollments` (
	...
	`enrolledAt` integer DEFAULT '"2026-05-20T00:03:39.101Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_chatMessages` (
	...
	`role` text NOT NULL,
	`content` text NOT NULL,
	`createdAt` integer DEFAULT '"2026-05-20T00:03:39.100Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_documentSummaries` (
	...
	`keyPoints` text,
	`createdAt` integer DEFAULT '"2026-05-20T00:03:39.100Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-05-20T00:03:39.100Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_documents` (
	...
	`createdAt` integer DEFAULT '"2026-05-20T00:03:39.099Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-05-20T00:03:39.099Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_documents`("id", "userId", "title", "description", "subject", "fileUrl", "fileKey", "fileName", "fileSize", "mimeType", "extractedText", "isFavorite", "isPublic", "courseId", "materialType", "createdAt", "updatedAt") SELECT "id", "userId", "title", "description", "subject", "fileUrl", "fileKey", "fileName", "fileSize", "mimeType", "extractedText", "isFavorite", "isPublic", NULL, 'other', "createdAt", "updatedAt" FROM `documents`;--> statement-breakpoint
...
CREATE TABLE `__new_progressTracking` (
	...
	`lastActivityAt` integer DEFAULT '"2026-05-20T00:03:39.101Z"' NOT NULL,
	`createdAt` integer DEFAULT '"2026-05-20T00:03:39.101Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-05-20T00:03:39.101Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2026-05-20T00:03:39.084Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-05-20T00:03:39.085Z"' NOT NULL,
	`lastSignedIn` integer DEFAULT '"2026-05-20T00:03:39.085Z"' NOT NULL
);
--> statement-breakpoint
