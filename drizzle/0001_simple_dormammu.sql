...
CREATE TABLE `__new_chatMessages` (
	...
	`createdAt` integer DEFAULT '"2026-04-14T00:23:24.949Z"' NOT NULL
);
...
CREATE TABLE `__new_documentSummaries` (
	...
	`keyPoints` text,
	`createdAt` integer DEFAULT '"2026-04-14T00:23:24.949Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-04-14T00:23:24.949Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_progressTracking` (
	...
	`lastActivityAt` integer DEFAULT '"2026-04-14T00:23:24.949Z"' NOT NULL,
	`createdAt` integer DEFAULT '"2026-04-14T00:23:24.949Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-04-14T00:23:24.949Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2026-04-14T00:23:24.948Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-04-14T00:23:24.948Z"' NOT NULL,
	`lastSignedIn` integer DEFAULT '"2026-04-14T00:23:24.948Z"' NOT NULL
);
--> statement-breakpoint
