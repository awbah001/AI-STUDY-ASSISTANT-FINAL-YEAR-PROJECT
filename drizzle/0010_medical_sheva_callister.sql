...
CREATE TABLE `__new_announcements` (
	...
	`createdAt` integer DEFAULT '"2026-09-02T14:05:58.992Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_announcements`("id", "courseId", "lecturerId", "title", "content", "createdAt") SELECT "id", "courseId", "lecturerId", "title", "content", "createdAt" FROM `announcements`;--> statement-breakpoint
...
CREATE INDEX `announcements_courseId_idx` ON `announcements` (`courseId`);--> statement-breakpoint
CREATE TABLE `__new_assignments` (
	...
	`documentId` integer,
	`createdAt` integer DEFAULT '"2026-09-02T14:05:58.992Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-09-02T14:05:58.992Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_assignments`("id", "courseId", "lecturerId", "title", "description", "dueDate", "documentId", "createdAt", "updatedAt") SELECT "id", "courseId", "lecturerId", "title", "description", "dueDate", "documentId", "createdAt", "updatedAt" FROM `assignments`;--> statement-breakpoint
DROP TABLE `assignments`;--> statement-breakpoint
ALTER TABLE `__new_assignments` RENAME TO `assignments`;--> statement-breakpoint
CREATE INDEX `assignments_courseId_idx` ON `assignments` (`courseId`);--> statement-breakpoint
CREATE TABLE `__new_chatMessages` (
	...
	`role` text NOT NULL,
	`content` text NOT NULL,
	`createdAt` integer DEFAULT '"2026-09-02T14:05:58.991Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_courseEnrollments` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`courseId` integer NOT NULL,
	`studentId` integer NOT NULL,
	`enrolledAt` integer DEFAULT '"2026-09-02T14:05:58.992Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_courseEnrollments`("id", "courseId", "studentId", "enrolledAt") SELECT "id", "courseId", "studentId", "enrolledAt" FROM `courseEnrollments`;--> statement-breakpoint
DROP TABLE `courseEnrollments`;--> statement-breakpoint
ALTER TABLE `__new_courseEnrollments` RENAME TO `courseEnrollments`;--> statement-breakpoint
CREATE INDEX `enrollments_courseId_idx` ON `courseEnrollments` (`courseId`);--> statement-breakpoint
CREATE INDEX `enrollments_studentId_idx` ON `courseEnrollments` (`studentId`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_courses`("id", "lecturerId", "title", "code", "subject", "description", "isActive", "createdAt", "updatedAt") SELECT "id", "lecturerId", "title", "code", "subject", "description", "isActive", "createdAt", "updatedAt" FROM `courses`;--> statement-breakpoint
...
CREATE INDEX `courses_lecturerId_idx` ON `courses` (`lecturerId`);--> statement-breakpoint
CREATE TABLE `__new_documentSummaries` (
	...
	`keyPoints` text,
	`createdAt` integer DEFAULT '"2026-09-02T14:05:58.991Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-09-02T14:05:58.991Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_documents` (
	...
	`courseId` integer,
	`materialType` text DEFAULT 'other',
	`createdAt` integer DEFAULT '"2026-09-02T14:05:58.990Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-09-02T14:05:58.990Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_documents`("id", "userId", "title", "description", "subject", "fileUrl", "fileKey", "fileName", "fileSize", "mimeType", "extractedText", "isFavorite", "isPublic", "courseId", "materialType", "createdAt", "updatedAt") SELECT "id", "userId", "title", "description", "subject", "fileUrl", "fileKey", "fileName", "fileSize", "mimeType", "extractedText", "isFavorite", "isPublic", "courseId", "materialType", "createdAt", "updatedAt" FROM `documents`;--> statement-breakpoint
DROP TABLE `documents`;--> statement-breakpoint
ALTER TABLE `__new_documents` RENAME TO `documents`;--> statement-breakpoint
CREATE INDEX `userIdIdx` ON `documents` (`userId`);--> statement-breakpoint
CREATE INDEX `documents_courseId_idx` ON `documents` (`courseId`);--> statement-breakpoint
CREATE TABLE `__new_flashcards` (
	...
	`srInterval` integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_flashcards`("id", "documentId", "userId", "question", "answer", "isFavorite", "reviewCount", "lastReviewedAt", "easeFactor", "srInterval", "repetitions", "dueDate", "createdAt", "updatedAt") SELECT "id", "documentId", "userId", "question", "answer", "isFavorite", "reviewCount", "lastReviewedAt", "easeFactor", "srInterval", "repetitions", "dueDate", "createdAt", "updatedAt" FROM `flashcards`;--> statement-breakpoint
DROP TABLE `flashcards`;--> statement-breakpoint
ALTER TABLE `__new_flashcards` RENAME TO `flashcards`;--> statement-breakpoint
CREATE INDEX `flashcard_documentId_idx` ON `flashcards` (`documentId`);--> statement-breakpoint
CREATE INDEX `flashcard_userId_idx` ON `flashcards` (`userId`);--> statement-breakpoint
CREATE INDEX `flashcard_dueDate_idx` ON `flashcards` (`dueDate`);--> statement-breakpoint
CREATE TABLE `__new_progressTracking` (
	...
	`lastActivityAt` integer DEFAULT '"2026-09-02T14:05:58.991Z"' NOT NULL,
	`createdAt` integer DEFAULT '"2026-09-02T14:05:58.991Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-09-02T14:05:58.991Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`expoPushToken` text,
	`createdAt` integer DEFAULT '"2026-09-02T14:05:58.989Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2026-09-02T14:05:58.989Z"' NOT NULL,
	`lastSignedIn` integer DEFAULT '"2026-09-02T14:05:58.989Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_users`("id", "openId", "name", "email", "loginMethod", "passwordHash", "avatarUrl", "role", "isBanned", "expoPushToken", "createdAt", "updatedAt", "lastSignedIn") SELECT "id", "openId", "name", "email", "loginMethod", "passwordHash", "avatarUrl", "role", "isBanned", "expoPushToken", "createdAt", "updatedAt", "lastSignedIn" FROM `users`;--> statement-breakpoint
